...
@MainBot.on_callback_query(filters.regex(r'^index'))
...
@MainBot.on_message(filters.private & filters.command('index'))
...
@MainBot.on_message(filters.command('setskip') & filters.user(ADMINS))
