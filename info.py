...
auth_channel = environ.get('AUTH_CHANNEL', '-1002385908762') # give your force subscribe channel IDs here separated by space
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://new-autofilter-paid-95f4d6f1dac9.herokuapp.com/")
