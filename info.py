...
# Bot information
SESSION = environ.get('SESSION', 'VLCBoxBot')
API_ID = int(environ.get('API_ID', '15396205'))
API_HASH = environ.get('API_HASH', '6b43ca35c89ae9d387f672b09593d47e')
BOT_TOKEN = environ.get('BOT_TOKEN', "8532012562:AAGO1qSx0vkiFJf74mq3BtmWu3MW6pc6KVk")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://graph.org/file/bb6c7cd3b95cf78066366-429b1c24814ebc4cb4.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1315069250').split()] # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002385908762 -1002824317499 -1002894373743') # give your force subscribe channel IDs here separated by space
...
reqst_channel = environ.get('REQST_CHANNEL', '-1003700508326')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003880007508')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003793464034')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003814069383').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vlcbotuser:ueFRBJvPBmWGqGYi@vlcbox-cluster.mqjtn7r.mongodb.net/?appName=vlcbox-cluster")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "vlcboxfilterbot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'vlcboxcollection')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/f80b8ab2294f22cdf0376-b0bb8edfb0975682b3.jpg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+VK0FJwgy_QE3ZDI1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/vlcbox')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'vlcboxsupport') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/rickakhtar')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'ce99efd97d05ce5f3698112d843b01a1f6e735d6')
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'ce99efd97d05ce5f3698112d843b01a1f6e735d6')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://rickfilterbot-b7ba9cb1b12d.herokuapp.com/")
